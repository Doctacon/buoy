...
from buoy_search.retrieval.retriever import RetrievalOptions, ranking_defaults_for_namespace
...
class AutoresearchExperiment:
    ...
    def plan_dict(self, *, out_dir: Path) -> dict[str, object]:
        return {
            ...
            "runner": "buoy_search.evals.autoresearch",
            "one_shot": True,
            "config_only": True,
...
def runtime_config_from_payload(payload: Mapping[str, object]) -> RuntimeConfig:
    ...
    namespace = required_string(payload, "namespace")
...
def run_experiment(experiment: AutoresearchExperiment, *, out_dir: Path) -> dict[str, object]:
    ...
    if experiment.mode == "fixture":
        ...
        from buoy_search.evals.core import run_live_evals
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m buoy_search.evals.autoresearch",
