...
def _run_status(args: argparse.Namespace) -> int:
    from buoy_search.telemetry.writer import telemetry_status_command
...
def _run_flush(args: argparse.Namespace) -> int:
    from buoy_search.telemetry.writer import telemetry_flush_command
...
def _run_migrate(args: argparse.Namespace) -> int:
    from buoy_search.telemetry.writer import telemetry_migrate_command
