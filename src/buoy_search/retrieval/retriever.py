...
from buoy_search.retrieval.ranking_defaults import (
    REPOSITORY_RANKING_DEFAULTS,
    WEBSITE_RANKING_DEFAULTS,
)
...
DEFAULT_TOP_K = 5
DEFAULT_CANDIDATES = REPOSITORY_RANKING_DEFAULTS.candidates
DEFAULT_RANKING_POOL = REPOSITORY_RANKING_DEFAULTS.ranking_pool
DEFAULT_RANKING_MODE = REPOSITORY_RANKING_DEFAULTS.ranking_mode
DEFAULT_RANKING_PROFILE = REPOSITORY_RANKING_DEFAULTS.ranking_profile
DEFAULT_RANKING_AGGREGATION = REPOSITORY_RANKING_DEFAULTS.ranking_aggregation
DEFAULT_WEBSITE_RANKING_MODE = WEBSITE_RANKING_DEFAULTS.ranking_mode
DEFAULT_WEBSITE_RANKING_PROFILE = WEBSITE_RANKING_DEFAULTS.ranking_profile
DEFAULT_WEBSITE_RANKING_POOL = WEBSITE_RANKING_DEFAULTS.ranking_pool
DEFAULT_WEBSITE_RANKING_AGGREGATION = WEBSITE_RANKING_DEFAULTS.ranking_aggregation
...
def ranking_defaults_for_namespace(
    ...
    *,
    ...
    if source_kind in {"website", "document", "database"} or (
        ...
        return WEBSITE_RANKING_DEFAULTS.ranking_options()
    return REPOSITORY_RANKING_DEFAULTS.ranking_options()
