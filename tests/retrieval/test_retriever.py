...
from buoy_search.evals.core import hit_summary
...
class RetrieverTests(unittest.TestCase):
    def test_from_config_uses_float16_for_query_embedding(self) -> None:
        ...
        with patch.dict(os.environ, {"TURBOPUFFER_API_KEY": "test-key"}, clear=False), patch(
            "buoy_search.retrieval.retriever.SentenceTransformerEmbedder", PrecisionCapturingEmbedder
        ), patch("buoy_search.retrieval.retriever.build_namespace", return_value=namespace):
