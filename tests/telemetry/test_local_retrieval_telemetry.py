...
from buoy_search.telemetry import producer as telemetry_module
...
from buoy_search.telemetry.queue import PublicationResult, telemetry_paths
...
class LocalRetrievalTelemetryTests(unittest.TestCase):
    ...
    def test_invalid_otel_environment_cannot_break_import_or_retrieval(self) -> None:
        script = textwrap.dedent(
            """
            import os
            import buoy_search.telemetry.producer as telemetry
            from buoy_search.config import RuntimeConfig
            from buoy_search.retrieval.retriever import HybridRetriever, RetrievalOptions
