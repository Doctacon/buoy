...
from buoy_search.telemetry import queue as telemetry_queue, store as telemetry_store, writer as telemetry_writer
...
from buoy_search.telemetry.writer import (
    run_writer,
    telemetry_flush,
...
class Version2QueueStoreMigrationTests(unittest.TestCase):
    ...
    def test_status_flush_producer_writer_and_migrate_are_network_inert(self) -> None:
        ...
        forbidden_modules = {
            ...
            "buoy_search.retrieval.retriever": None,
            "buoy_search.retrieval.routing": None,
        }
        with (
            patch.object(
            ...
            patch(
                "buoy_search.telemetry.writer.request_writer_start",
                return_value=None,
            ),
        ):
            self.assertTrue(publish_envelope(payload, paths=self.v2).published)
