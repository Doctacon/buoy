...
from buoy_search.telemetry import queue
...
class TelemetryQueueTests(unittest.TestCase):
    ...
    def test_module_has_no_forbidden_runtime_imports(self) -> None:
        ...
        self.assertNotIn("buoy_search.telemetry.writer", modules)
        self.assertNotIn("buoy_search.telemetry.store", modules)
