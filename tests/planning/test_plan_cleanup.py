...
from buoy_search.planning.plan_artifacts import build_plan_artifacts, write_plan_artifacts
from buoy_search.planning import plan_cleanup
from buoy_search.planning.plan_cleanup import cleanup_applied_plan_directory, cleanup_superseded_plan_directories
...
class PlanCleanupTests(unittest.TestCase):
    ...
    def test_applied_cleanup_does_not_delete_replacement_raced_after_verification(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("buoy_search.planning.plan_cleanup.os.rename", side_effect=race_then_rename):
    ...
    def test_canonical_managed_plan_with_custom_state_uses_bound_anchor(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("buoy_search.local_paths.Path.home", return_value=home):
                ...
                with patch(
                    "buoy_search.planning.plan_cleanup._open_directory_chain",
    ...
    def test_cleanup_rejects_managed_ancestor_swapped_to_symlink_after_verification(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("buoy_search.local_paths.Path.home", return_value=home):
                ...
                with patch(
                    "buoy_search.planning.plan_cleanup._verified_plan_identity",
