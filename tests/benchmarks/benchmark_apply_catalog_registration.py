...
from buoy_search.catalog.local import load_routing_embedder
...
from tests.planning.test_apply_catalog_registration import FakeClient, MODEL, REGION
from tests.cli.test_apply_cli import build_saved_plan
