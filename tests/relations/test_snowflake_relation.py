...
from buoy_search.relations.snowflake import (
...
class SnowflakeRelationTests(unittest.TestCase):
    ...
    def test_named_connection_query_tag_timeout_read_only_sql_and_fetchmany(self) -> None:
        ...
        with patch("buoy_search.relations.snowflake._load_connector", return_value=FakeSnowflakeConnector):
    ...
    def test_missing_dependency_error(self) -> None:
        import buoy_search.relations.snowflake as module
