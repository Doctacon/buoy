...
Blocked until this record-only governance reconciliation integrates, then one replacement release PR must be opened because PR #80 is closed, conflicting, and pinned to stale head `a2142205cae8ccfce9ed5f4d3b4785413621812b`. The replacement must pass current-head checks and any mechanically required last-push approval.
