...
- Observe validation/build completion and the release environment wait; approve only the expected commit/version/artifacts.
...
- Approval is the mutation boundary and only the expected run is approved.
