...
5. `.10x/tickets/2026-07-14-repair-release-workflow-and-bump-v0-2-1.md` — validate remote tag metadata, bump patch version, commit/push, pass CI.
6. `.10x/tickets/2026-07-14-create-buoy-v0-2-1-github-release.md` — approval-gated first GitHub Release.
...
- 2026-07-14: CI/public files, validation, commit/push, and main CI completed. Release child created the exact annotated tag but hosted tag-object validation failed before build or approval. Parent is blocked with external state preserved.

## Blockers

- `.10x/tickets/2026-07-14-create-buoy-v0-2-0-github-release.md` requires explicit user ratification of recovery ref/version semantics.
